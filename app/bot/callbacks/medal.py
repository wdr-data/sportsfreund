...
def medals_table(event, parameters, **kwargs):
    ...
    if country:
        ...
        if olympic_event == 'owg14':
            ...
            total_medals_count = MedalsTable.with_medals_count(topic_id='548')
        else:
            total_medals_count = MedalsTable.with_medals_count()
            if not total_medals_count:
