...
handlers = [
    ...
    PayloadHandler(result_apply, [KEY_SUB, Subscription.Type.RESULT.value, KEY_FILTER, KEY_ACTION]),
    PayloadHandler(sport_change, [KEY_SUB, Subscription.Target.SPORT.value, KEY_ACTION]),
    PayloadHandler(athlete_change, [KEY_SUB, Subscription.Target.ATHLETE.value, KEY_ACTION]),
    PayloadHandler(medal_apply, [KEY_SUB, Subscription.Type.MEDAL.value, KEY_FILTER, KEY_ACTION]),
    PayloadHandler(medal_change, [KEY_SUB, Subscription.Type.MEDAL.value, KEY_ACTION]),
